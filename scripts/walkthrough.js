...
// 	console.log("In drawSubgoal, is isSetSubgoalQuestions? ", isSetSubgoalQuestions);
// 	//get current subgoal, empty question container and add in subgoal questions
//     var personaName = getVarFromLocal("personaName");
//     var pronoun = getVarFromLocal("personaPronoun");
//     var possessive = getVarFromLocal("personaPossessive");
// 	var subName = localStorage.getItem("currSubgoalName");
// 	console.log("In drawSubgoal, currSubgoalName is", subName);
// 	console.log("In drawSubgoal, pronoun is", pronoun);
// 	console.log("In drawSubgoal, personaName is", personaName);
// 	console.log("In drawSubgoal, personaPossessive is", possessive);
...
//helper function to remove onclick = 
